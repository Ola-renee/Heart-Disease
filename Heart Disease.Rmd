...
Compared to logistic regression, decision trees handle non-linear relationships between predictors and the outcome variable more naturally.Uunlike logistic regression which outputs probabilities, decision trees classify patients by splitting the dataset into homogenous subsets based on a series of decisions.
...
Limitations for this study firstly because of the data set itself because it wasnt a very big dataset so it didnt provide enough of information that could be needed to model a better analysis for heart disease.
Also when doing the clutering it was hard to visualisation the the Dendrogram despite increasing size and changing it view.
